...
card.addEventListener("mouseenter", function () {
    containerView.classList.add("view-text");
});

card.addEventListener("mouseleave", function () {
    containerView.classList.remove("view-text");
});
...
// إنشاء الانميشن باستخدام GSAP
gsap.from(main, {
    opacity: 0, // تحديد خاصية التعتيم
    y: 100, // تحديد الانتقال العمودي
    duration: 1, // تحديد مدة الانميشن بالثواني
    ease: "power2.out" // تحديد السرعة أو الاسترخاء للانميشن
});
